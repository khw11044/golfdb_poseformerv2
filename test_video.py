...
if __name__ == '__main__':
    ...
    parser.add_argument('-v', '--video', help='Path to video that you want to test', default='test_video.mp4')
    parser.add_argument('-s', '--seq-length', type=int, help='Number of frames to use per forward pass', default=64)
    parser.add_argument('-m', '--model', help='Path to model that you want to test', default='models/image_/swingnet_01800.pth.tar')
